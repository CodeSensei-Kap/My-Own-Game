...
function preload()
{
  ...
  rabbit = loadImage('Pikachu_BDSP.png');
...
function setup() 
{
  ...
  bln_btn = createImg('baloon2.png');
  bln_btn.position(250,350);
  bln_btn.size(115,130);
  bln_btn.mouseClicked(airBlow);
  ...
  star1 = createSprite(60,350,60,60);
  star1.scale = 0.02;

  star1.addImage(starImg);

  star2 = createSprite(300,50,60,60);
  star2.scale = 0.02;
...
function draw() 
{
  ...
  {
    bunny.changeImage('angry-pikachu.gif');
    bk_song.stop();
    sad_sound.play();
    fruit=null;
   }
   ...
   {
     star1.visible = false;
     star.changeAnimation('2');
   }

   if (collide(fruit,star2,20)==true)
   {
     star2.visible = false;
     star.changeAnimation('1');
   }
